[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-f059dc9a6f8d3a56e377f745f24479a46679e63a5d9fe6f495e02850cd0d8118.svg)](https://classroom.github.com/online_ide?assignment_repo_id=6513735&assignment_repo_type=AssignmentRepo)

# Recipe App

The Recipe App is a one-day hackathon project executed by Ted Phillips and Scott Wilson on 10/12/21. This app allows you to search for a recipe using a fetch request from a recipe API. It then displays the most relevent recipe from the search. Within this recipe you can see the ingredients that it requires using a drop down menu using the details HTML tag. There is also a link to the full recipe. Finally, you can favourite the recipe to save it in a list so you don't forget the name.

## Installation:

1. Clone to VS Code
2. Open a live server
...
- Using different HTML tags such as details
